...
用法:
    python scripts/ind_oos.py v5           # 运行 v5 OOS
    python scripts/ind_oos.py v4 v5        # 对比 v4 vs v5 OOS
"""
...
def run_version_oos(version: str) -> dict:
    ...
    strategy = StrategyRegistry.create("ind", version, config_override)
    ...
    output_dir = Path("output/oos_compare/ind")
