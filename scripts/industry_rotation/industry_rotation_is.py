...
用法:
    python scripts/industry_rotation_is.py v1           # 运行 v1
    python scripts/industry_rotation_is.py v2           # 运行 v2
    python scripts/industry_rotation_is.py v1 v2        # 对比 v1 vs v2
"""
...
def run_version(version: str) -> dict:
    ...
    strategy = StrategyRegistry.create("industry_rotation", version)
