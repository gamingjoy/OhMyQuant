...
@register_strategy("industry_rotation", "v1")
class IndustryRotationStrategyV1(BaseStrategy):
    """行业轮动策略 v1：行业动量基线版 (mom20_60_top5_ind2_csi300)"""

    @classmethod
    def from_version(
        cls, strategy_type: str, version: str, config: dict | None = None
    ) -> "IndustryRotationStrategyV1":
        if strategy_type != "industry_rotation" or version != "v1":
