...
@register_strategy("industry_rotation", "v2")
class IndustryRotationStrategyV2(BaseStrategy):
    """行业轮动策略 v2：周频调仓+波动率目标 (mom20_60_top5_ind2_csi300_weekly)"""

    @classmethod
    def from_version(
        cls, strategy_type: str, version: str, config: dict | None = None
    ) -> "IndustryRotationStrategyV2":
        if strategy_type != "industry_rotation" or version != "v2":
