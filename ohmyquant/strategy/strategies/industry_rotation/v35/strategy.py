"""行业轮动策略 v35（v30基础上新增margin_stability因子）—— [iter]

状态: iter（试验中，2026-07-20）
baseline: v30 (IS 0.4249 / OOS 2.6787 / OOS +6.66%)

v35 = v30 + 新增margin_stability因子（weight=1.0）

设计目的：
  v30使用12因子，v35新增margin_stability（利润率稳定性）
  验证"质量稳定性因子是否能提升选股能力"
"""
...
@register_strategy("industry_rotation", "v35")
class IndustryRotationStrategyV35(BaseStrategy):
    """行业轮动策略 industry_rotation_v35 (v30_margin_stability, iter)"""

    @classmethod
    def from_version(
        cls, strategy_type: str, version: str, config: dict | None = None
    ) -> "IndustryRotationStrategyV35":
        if strategy_type != "industry_rotation" or version != "v35":
            raise ValueError(f"不支持的策略版本: {strategy_type} {version}")

        base_config = {
            "strategy_type": "industry_rotation",
            "strategy_version": "v35",
            "strategy_name": "行业轮动策略 industry_rotation_v35 (v30_margin_stability, iter)",
            "description": "v30+margin_stability因子 [iter]",
            "backtest": {
            ...
            "selection": {
                ...
                "industry_rotation": {
                    ...
                    "factor_weights": {
                        ...
                        "margin_stability": 1.0,  # NEW in v35
                    },
                },
            },
            "portfolio": {
